...
describe('DashboardView home composer', () => {
  ...
  it('renders composer and approve-first cards when a project is selected', async () => {
    ...
    expect(wrapper.get('[data-testid="home-composer"]').exists()).toBe(true)
  ...
  it('shows project empty state when no project is stored', async () => {
    ...
    const wrapper = mountDashboard()
    await flushPromises()
    expect(wrapper.get('[data-testid="home-no-project"]').exists()).toBe(true)
  ...
  it('shows pipeline empty state when none are approve-first', async () => {
    ...
    const wrapper = mountDashboard()
    await flushPromises()
    expect(wrapper.get('[data-testid="home-pipelines-empty"]').exists()).toBe(true)
    wrapper.unmount()
  })
