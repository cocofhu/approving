...
func OptionDescriptors() []OptionDescriptor {
	return []OptionDescriptor{
		...
		{Env: "GRASP_SANDBOX_IMAGE", YAML: "sandbox.image", Type: "image", Default: "", ZH: "强制所有后端使用同一沙箱镜像（不推荐；优先 sandbox.images）", EN: "Force one sandbox image for every backend (prefer sandbox.images)"},
		{Env: "GRASP_SANDBOX_IMAGE_CURSOR", YAML: "sandbox.images.cursor", Type: "image", Default: "", ZH: "cursor 后端沙箱镜像；留空用内置默认", EN: "Sandbox image for cursor backend; empty uses the built-in default"},
		{Env: "GRASP_SANDBOX_IMAGE_CLAUDE_CODE", YAML: "sandbox.images.claude_code", Type: "image", Default: "", ZH: "claude_code 后端沙箱镜像；留空用内置默认", EN: "Sandbox image for claude_code backend; empty uses the built-in default"},
		{Env: "GRASP_SANDBOX_IMAGE_CODEBUDDY", YAML: "sandbox.images.codebuddy", Type: "image", Default: "", ZH: "codebuddy 后端沙箱镜像；留空用内置默认", EN: "Sandbox image for codebuddy backend; empty uses the built-in default"},
		{Env: "GRASP_SANDBOX_IMAGE_TRAE", YAML: "sandbox.images.trae", Type: "image", Default: "", ZH: "trae 后端沙箱镜像；留空用内置默认", EN: "Sandbox image for trae backend; empty uses the built-in default"},
		{Env: "GRASP_SANDBOX_IMAGE_OPENCODE", YAML: "sandbox.images.opencode", Type: "image", Default: "", ZH: "opencode 后端沙箱镜像；留空用内置默认", EN: "Sandbox image for opencode backend; empty uses the built-in default"},
