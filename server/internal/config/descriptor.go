...
func OptionDescriptors() []OptionDescriptor {
	return []OptionDescriptor{
		...
		{Env: "APPROVING_SANDBOX_IMAGE_OPENCODE", YAML: "sandbox.images.opencode", Type: "image", Default: "", ZH: "opencode 后端沙箱镜像；留空用内置默认", EN: "Sandbox image for opencode backend; empty uses the built-in default"},
		...
		{Env: "APPROVING_OPENCODE_CATALOG_URL", YAML: "sandbox.opencode_catalog_url", Type: "URL", Default: "https://models.dev/api.json", ZH: "OpenCode 模型目录地址；出网受限时改指镜像", EN: "OpenCode model catalog URL; point at a mirror when egress is restricted"},
