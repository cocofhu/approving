...
`publish-sandbox` for an existing `v*` tag such as `v0.3.6-beta`).
...
- `ghcr.io/cocofhu/approving:0.3.6-beta`
- `ghcr.io/cocofhu/sandbox-gateway:0.3.6-beta`
- `ghcr.io/cocofhu/universal-sandbox-{cursor,claude_code,codebuddy,trae}:0.3.6-beta`
